    ...
    <section align="center">
        ...
        <div class="add" hidden>
            <form style="text-align:center" method="post" action="modifyInstructors.php">
                ...
                <div > <label>Instructor DOB : </label>
                    <input type="date" placeholder="Enter Instructor DOB" name="i_dob" required>
                </div>
                ...
                <div > <label>Instructor start date : </label>
                    <input type="date" placeholder="Enter Instructor start date" name="i_start_date" required>
                </div>
        ...
        if (isset($_POST['add'])) {
            ...
            if (mysqli_query($conn, $sql)) {
                logger("INFO","MANAGER $S_Id ADDED INSTRUCTOR $i_id");
                echo "<script>
                alert('Instructor added successfully');
                window.location.href='modifyInstructors.php';
                </script>";
            } else {
                logger("ERROR","MANAGER $S_Id ADD INSTRUCTOR FAILED");
                echo "<script>
        ...
        if (isset($_POST['remove'])) {
            ...
            if ($count == 0) {
                logger("ERROR","MANAGER $S_Id DELETE INSTRUCTOR FAILED");
                echo "<script>
                alert('Incorrect Instructor Id');
                window.location.href='modifyInstructors.php';
                </script>";
            ...
            if ($count != 0 && mysqli_query($conn, $sql)) {
                logger("INFO","MANAGER $S_Id DELETED INSTRUCTOR $I_id_drop");
                echo "<script>
