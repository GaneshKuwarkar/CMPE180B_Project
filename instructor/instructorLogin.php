...
<body>
    ...
    <form style="text-align:center" method="post" action="instructorLogin.php">
        ...
        <div class="container">
            ...
            <div><button type="submit" name="InstructorLogin" style="height:23px; width: 55px">Login</button> </div>
    ...
    <section align="center">
        ...
        if (isset($_POST['InstructorLogin'])) {
            extract($_POST);
            $sql = "select I_id from instructor where I_email = '$username' and I_password = '$password'";
