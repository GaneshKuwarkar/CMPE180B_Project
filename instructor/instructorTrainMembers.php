...
<body>
    <section align="center">
        ...
        <div class="view" hidden>
            <?php
            $sql = "select P_id, P_method, P_amount, P_time, P_date from payment where M_id = '$M_Id'";
            $result = mysqli_query($conn, $sql);
            echo "<br>";
            echo "<table border='1' align='center'>";
            echo "<tr>";
            echo "<td>ID<td>Payment Method<td>Amount<td>Time<td>Date<td>";
            echo "</tr>";
        ...
        if (isset($_POST['payment'])) {
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                window.location.href='instructorTrainMembers.php';
                </script>";
            } else {
                echo "<script>
